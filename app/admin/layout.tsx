...
export default function AdminLayout({
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-950">
        <div className="text-center">
          ...
          <p className="text-white font-medium">Chargement du panel d'administration...</p>
        </div>
      </div>
    )
  }
        ...
        <div className="relative z-10 w-full max-w-md p-4">
          <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-3xl p-8 shadow-2xl shadow-black/35">
            ...
            <div className="flex flex-col items-center mb-8">
              ...
              <p className="text-white/60 text-sm mt-1">Connectez-vous pour gérer votre site</p>
            </div>
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3 bg-black/35 border border-white/10 rounded-2xl text-white placeholder-white/20 focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none transition-all"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="••••••••••••"
                    className="w-full pl-12 pr-12 py-3 bg-black/35 border border-white/10 rounded-2xl text-white placeholder-white/20 focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none transition-all"
                  />
                  <button
                    type="button"
              ...
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-2 rounded-2xl bg-orange-800 px-6 py-3 text-white text-lg font-semibold shadow-lg shadow-orange-800/20 hover:bg-orange-900 disabled:bg-orange-800/50 disabled:cursor-not-allowed transition-colors mt-2"
              >
                {formLoading ? (
                  <>
  ...
  return (
    <div className="flex min-h-screen bg-slate-950 text-white relative">
      ...
      <div className="absolute bottom-0 left-64 w-96 h-96 bg-orange-500/5 rounded-full blur-3xl pointer-events-none" />
