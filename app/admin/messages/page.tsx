    ...
    <div>
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-8">
        <div>
          ...
          <p className="text-orange-800/80 text-sm mt-1">Gérez les messages envoyés via le formulaire de contact</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-16 bg-white/5 border border-white/10 rounded-3xl">
          ...
          <p className="text-orange-800/80 font-medium">Aucun message ne correspond aux critères.</p>
        </div>
      ) : (
            ...
            >
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div className="flex-grow">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-y-2 gap-x-4 mt-2 text-sm text-orange-800/90">
                  ...
                  <div className="mt-4 bg-black/25 rounded-2xl p-4">
                    <p className="text-orange-800 text-sm italic">&quot;{msg.message}&quot;</p>
                  </div>
                </div>
