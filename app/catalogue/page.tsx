          ...
          <div className="container mx-auto px-4 max-w-2xl">
            <div className="card border-t-4 border-orange-800 p-10 shadow-2xl">
              ...
              <div className="text-center mb-10">
                ...
                <p className="text-orange-800/60 mt-3 text-sm">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-11 pr-4 rounded-2xl border py-3 bg-black/35 text-white placeholder-orange-200/20 focus:ring-2 focus:ring-orange-800 outline-none transition-all text-sm ${
                          errors.name
                            ? 'border-red-400'
                            : 'border-white/10'
                        }`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-2xl bg-black/35 border border-white/10 text-white placeholder-orange-200/20 focus:ring-2 focus:ring-orange-800 outline-none transition-all text-sm"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 rounded-2xl border bg-black/35 text-white placeholder-orange-200/20 focus:ring-2 focus:ring-orange-800 outline-none transition-all text-sm ${
                  ...
                  <p className="text-center text-xs text-orange-800/40 mt-2">
